  ...
  return (
    <main className="processing-page">
      <section className="processing-card" aria-live="polite">
        ...
        <p>Everything is happening on your device. This usually takes only a few seconds.</p>
        ...
        <div className="processing-private"><ShieldCheck size={16} /> No document contents leave your browser</div>
      </section>
    </main>
  )
}
